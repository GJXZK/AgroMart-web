...
export const useMusicDetail = defineStore('PlayingMusicUrl', () => {
  ...
  return {HomefooterState,musicName,musicSinger,PlayingMusicUrl, musicTime,musicTimeFormat,picUrl,updateMusic,updateMusicTime,updateMusicTimeFormat,updateMusicInfo}
})
